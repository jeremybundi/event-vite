<template>
  ...
  >
    <div
      class="bg-white rounded-lg shadow-lg p-6 w-full max-w-lg relative overflow-y-auto max-h-[80vh]"
    >
      ...
      <form @submit.prevent="createEvent" class="space-y-6">
        ...
        <div class="grid grid-cols-1 gap-4">
          ...
          <div>
            <label for="start_time" class="block text-gray-700"
              >Start Time</label
            >
            <input
          ...
          <div>
            <label for="total_tickets" class="block text-gray-700"
              >Total Tickets</label
            >
            <input
              v-model.number="event.total_tickets"
              id="total_tickets"
              type="number"
              class="mt-1 p-2 border rounded w-full"
              required
        ...
        <div>
          ...
          >
            <div class="grid grid-cols-1 gap-4">
              ...
              <div>
                <label :for="'price_' + index" class="block text-gray-700"
                  >Price</label
                >
                <input
                  v-model.number="category.price"
                  :id="'price_' + index"
                  type="number"
                  class="mt-1 p-2 border rounded w-full"
                />
              ...
              <div>
                ...
                >
                <input
                  v-model.number="category.quantity_available"
