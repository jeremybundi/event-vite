<template>
    <div class="bg-white border rounded-lg shadow-md p-3">
      <img :src="event.image_url" alt="Event image" class="w-full h-80 w-80 object-cover rounded-lg shadow-md mx-auto ">
  ...
  <style scoped>
  /* Add any specific styling for EventCard here */
  </style>
