    ...
    <div class="w-full max-w-xl bg-white rounded-lg shadow-lg p-6 space-y-6">
      ...
      <div v-if="!otpSent">
        ...
        <form @submit.prevent="registerUser">
          ...
          <button
            type="submit"
            class="w-full bg-lime-900 text-white py-3 px-4 rounded-md shadow-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 text-lg font-semibold mt-4"
          >
            Register
          </button>
        </form>
